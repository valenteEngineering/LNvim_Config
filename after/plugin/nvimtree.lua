...
-- THIS IS ALL LENTILS CODE TO QICKLY GO BETWEEN FILE AND NVIMTREE
...
-- Key map to hide side panel 
vim.keymap.set("n", "<leader>E", ":NvimTreeToggle<CR>", { desc = "NvimTree Toggle", silent = true, noremap = true })
